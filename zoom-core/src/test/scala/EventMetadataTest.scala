...
class EventMetadataTest extends FunSuite {
  ...
  val testEventMetadata = EventMetadata(
    ...
    env = Production,
    callsite = Some(Callsite("ec", "fi", 2, "no_commit", 0, false)),
    on_behalf_of = None
  )
  ...
  val testMap = Map("event_id" -> "38400000-8cf0-11bd-b23e-10b96e4ef00d", "event_type" -> "2",
    ...
    "node_id" -> "38400000-8cf0-11bd-b23e-10b96e4ef00e", "env" -> "Production", "callsite.enclosing_class" -> "ec", "callsite.file" -> "fi", "callsite.line" -> "2")
